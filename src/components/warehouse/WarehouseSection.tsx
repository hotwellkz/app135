              ...
              <div className="p-2 sm:p-3">
                ...
                <div className="sm:hidden">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <h3 className="text-sm font-medium text-gray-900 truncate max-w-[180px]">{product.name}</h3>
                      <p className="text-xs text-gray-500 truncate max-w-[180px]">{product.category}</p>
                    </div>
                    <div className="text-right">
                      <div className={`text-sm font-medium ${product.quantity <= 5 ? 'text-red-600' : 'text-gray-900'}`}>
                        {product.quantity} {product.unit}
                      </div>
                      <div className="text-xs text-gray-500">{product.averagePurchasePrice?.toLocaleString()} ₸</div>
